...
candidate_options = []
candidate_votes = {}
# Script Modification Suggestion 2
    #Create list and library for states 
    #state_names = []
    #state_votes = {}
...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        # Script Modification Suggestion #1
        # x_x = row[X]
...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes:
        ...
        if (county_vote > county_totalvotes):
            county_totalvotes = county_vote
